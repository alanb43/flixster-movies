...
class MoviesViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    // In a storyboard-based application, you will often want to do a little preparation before navigation
     override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let detailsViewController = segue.destination as! MovieDetailsViewController // seg-way is pronunciation
        detailsViewController.movie = movie
        
        // Remove the visible selection after the user taps on a movie, without this it shows it selected continually after they've clicked 
